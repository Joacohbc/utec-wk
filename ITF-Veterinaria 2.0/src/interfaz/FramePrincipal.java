...
public class FramePrincipal {
	...
	/**
	 *  M�todo que se ejecuta cuando se inicia la aplicaci�n. Invoca a "createAndShowGUI"
	...
	/** M�todo que inicializa toda la ventatna principal */
	...
	/** Inicialicaci�n de botones del menu de clientes */
	...
	/** Inicialicaci�n de botones del menu de Mascotas */
	...
	/** Inicialicaci�n de botones del menu de Veterinario */
	...
	/** Inicialicaci�n de botones del menu de Consultas */
