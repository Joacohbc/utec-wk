...
import components.builders.VTBBuilderOnlyText;
...
public class Test extends JFrame {
	...
	public Test() {
		...
		txtNombre = new VTBBuilderOnlyText().getResult();
		txtNombre.setBounds(170, 93, 114, 21);
		contentPane.add(txtNombre);
		contentPane.add(txtNombre.getErrorLabel());
		...
		contentPane.add(txtEdad.getErrorLabel());

		txtNacimiento = new VTextBox(true);
		...
		contentPane.add(txtNacimiento.getErrorLabel());
	}
}
